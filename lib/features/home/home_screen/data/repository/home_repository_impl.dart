...
class HomeRepositoryImpl extends HomeRepository {
  ...
  @override
  Future<DataState<Home>> getHome(String? token) async {
    try {
      final httpResponse = await _homeApiService.getHome('Bearer $token');
      ConsoleLogger.error(token.toString());
      ConsoleLogger.error(httpResponse.data.toString());
